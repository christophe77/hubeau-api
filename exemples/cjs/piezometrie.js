...
async function chroniques() {
  ...
  try {
    const results = await hubeauApi.piezometrie.chroniques(params);
    console.log(results);
  } catch (error) {
    console.log(error);
  }
...
async function chroniquesTr() {
  ...
  try {
    const results = await hubeauApi.piezometrie.chroniquesTr(params);
    console.log(results);
  } catch (error) {
    console.log(error);
  }
...
async function chroniquesTrCsv() {
  ...
  try {
    const results = await hubeauApi.piezometrie.chroniquesTrCsv(params);
    console.log(results);
  } catch (error) {
    console.log(error);
  }
...
async function stations() {
  ...
  try {
    const results = await hubeauApi.piezometrie.stations(params);
    console.log(results);
  } catch (error) {
    console.log(error);
  }
...
async function stationsCsv() {
  ...
  try {
    const results = await hubeauApi.piezometrie.stationsCsv(params);
    console.log(results);
  } catch (error) {
    console.log(error);
  }
